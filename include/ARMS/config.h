...
#define LEFT_MOTORS -7, 6, -3
#define RIGHT_MOTORS 18, 8, -20
#define GEARSET pros::E_MOTOR_GEAR_600 // RPM of chassis motors

// Ticks per inch
#define TPI 49.05     			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 1          // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH 11.75 		  // The distance between left and right wheels (or tracker wheels)
