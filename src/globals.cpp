...
lemlib::TrackingWheel left_tracking_wheel(
    &right_enc, 2.77,
    .375); // 2.75" wheel diameter, -4.6" offset from tracking center
lemlib::TrackingWheel back_tracking_wheel(
    &back_enc, 2.76,
    -3.75); // 2.75" wheel diameter, 4.5" offset from tracking center
...
lemlib::Chassis chassis(&left_side_motors, &right_side_motors, track_width,
                        lateralController, angularController, sensors);
